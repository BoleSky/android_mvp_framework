...
import cn.bole.tabnavigator.abs.IMeasurablePagerTitleView;
 ...
 */
public class TabNavigator extends FrameLayout implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    public void setAdapter(NavigatorAdapter adapter) {
        if (mAdapter == adapter) {
            return;
        }
        if (mAdapter != null) {
