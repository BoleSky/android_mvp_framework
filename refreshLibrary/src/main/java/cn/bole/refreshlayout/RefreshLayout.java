...
import cn.bole.refreshlayout.util.RefreshScrollingUtil;
...
public class RefreshLayout extends LinearLayout {
    ...
    public interface BGARefreshLayoutDelegate {
         ...
         * 开始刷新
         */
        void onBGARefreshLayoutBeginRefreshing(RefreshLayout refreshLayout);
         ...
         */
        boolean onBGARefreshLayoutBeginLoadingMore(RefreshLayout refreshLayout);
    }
